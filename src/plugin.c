...
const char* ts3plugin_name() {
	return "Channel monitoring plugin";
}
...
const char* ts3plugin_author() {
  return "MrGobus (mrgobus@gmail.com)";
}

/* Plugin description */
const char* ts3plugin_description() {
  return "Monitor user activity at channel for guild statistic.";
}
...
void ts3plugin_initMenus(struct PluginMenuItem*** menuItems, char** menuIcon) {
	...
	CREATE_MENU_ITEM(PLUGIN_MENU_TYPE_GLOBAL,  MENU_ID_GLOBAL_1,  "Start prime",  "1.png");
	CREATE_MENU_ITEM(PLUGIN_MENU_TYPE_GLOBAL,  MENU_ID_GLOBAL_2,  "Stop prime",  "2.png");
...
void ts3plugin_initHotkeys(struct PluginHotkey*** hotkeys) {
	*hotkeys = (struct PluginHotkey**)malloc(1);
	(*hotkeys)[0] = NULL;
}
...
/* Заданные мной методы. */

/**
 * В теории эта хрень срабатывает каждый раз как пользователь меняет канал.
 * Тут будем отслеживать заход и выход пользователей на канал.
 *
 * @param serverConnectionHandlerID [description]
 * @param clientID                  [description]
 * @param oldChannelID              [description]
 * @param newChannelID              [description]
 * @param visibility                [description]
 * @param moveMessage               [description]
 */

void ts3plugin_onClientMoveEvent(uint64 serverConnectionHandlerID, anyID clientID, uint64 oldChannelID, uint64 newChannelID, int visibility, const char* moveMessage) {
	ts3Functions.printMessageToCurrentTab("ts3plugin_onClientMoveEvent");
}

/**
 * Сработает если кто-то когото перетащил, если верить документации то вместо ts3plugin_onClientMoveEvent.
 *
 * @param serverConnectionHandlerID [description]
 * @param clientID                  [description]
 * @param oldChannelID              [description]
 * @param newChannelID              [description]
 * @param visibility                [description]
 * @param moverID                   [description]
 * @param moverName                 [description]
 * @param moverUniqueIdentifier     [description]
 * @param moveMessage               [description]
 */

void ts3plugin_onClientMoveMovedEvent(uint64 serverConnectionHandlerID, anyID clientID, uint64 oldChannelID, uint64 newChannelID, int visibility, anyID moverID, const char* moverName, const char* moverUniqueIdentifier, const char* moveMessage) {
	ts3Functions.printMessageToCurrentTab("ts3plugin_onClientMoveMovedEvent");
}
 ...
 * @param menuItemID                [description]
 * @param selectedItemID            [description]
 */
